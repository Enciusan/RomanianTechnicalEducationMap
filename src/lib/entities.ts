...
export interface CategoryMeta { color: string; order: number }

export const CATEGORY: Record<Category, CategoryMeta> = {
  universitate: { color: 'oklch(0.72 0.19 300)', order: 0 },
  facultate: { color: 'oklch(0.86 0.2 165)', order: 1 },
  liceu: { color: 'oklch(0.78 0.16 230)', order: 2 },
  robotica: { color: 'oklch(0.8 0.17 60)', order: 3 },
  centru_excelenta: { color: 'oklch(0.82 0.15 100)', order: 4 },
  asociatie_studenti: { color: 'oklch(0.75 0.17 350)', order: 5 },
  hub: { color: 'oklch(0.8 0.12 200)', order: 6 },
  ong: { color: 'oklch(0.65 0.02 260)', order: 7 },
}
